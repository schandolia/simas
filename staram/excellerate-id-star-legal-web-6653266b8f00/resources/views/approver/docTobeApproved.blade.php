...
<main class="main">
    <div class="container-fluid">
        <div class="animated fadeIn">
            <div class="page-title-heading">
                <div class="page-title-icon">
                    <i class="fa fa-pencil-square-o icon-gradient bg-deep-blue"></i>
                </div>
                <div>Documents Need to Approve</div>
            </div>
            <!-- /.card-->
            <div class="row pt-3">
                <div class="col">
        ...
        <input type="hidden" id="data-url" name="data-url" value="{{route('getTobeApprovedDocs')}}">
    </main>
@endsection
@section ('modal')
<!-- Modal Add Folder-->
