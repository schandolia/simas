...
<main class="main">
    <div class="container-fluid">
        ...
        <input type="hidden" id="data-tbl-url" name="data-tbl-url" value="{{route('getCompletedDocs')}}">
    </main>
@endsection
@section ('modal')
<!-- Modal Add Folder-->
...
<div class="modal fade" id="requestSubmissionModal" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-primary" role="document">
        ...
        <form onkeydown="return event.key!='Enter';" id="frmRequestSubmission" name="frmRequestSubmission" class="form-horizontal" action="{{route('reviseRequest')}}" method="POST" enctype="multipart/form-data">
            <div class="modal-body">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
