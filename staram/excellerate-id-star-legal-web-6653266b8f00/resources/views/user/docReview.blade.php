...
@section ('modal')
<!-- Modal Add Folder-->
<div class="modal fade" id="newReviewModal" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-primary" role="document">
        ...
        <form onkeydown="return event.key!='Enter';" id="frmSubmitReview" name="frmSubmitReview" class="form-horizontal" action="{{route('submitReview')}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="step1" role="tabpanel">
                        <div class="form-group row">
                            <div class="col">
                                <input class="form-control" id="proposed-by" type="text" name="proposed-by" placeholder="Proposed by">
                            </div>
                            <div class="col">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="attachment">Attachment</label>
                            <div class="col">
                    ...
                    <div class="tab-pane" id="step3" role="tabpanel">
                        <div class="form-group row">
                            ...
                            <div class="col" id="proposed-by-txt"></div>
                        </div>
                        <div class="form-group row">
                            <div class="col md-3">
                                Date
                            </div>
                            <div class="col" id="date-txt"></div>
                        </div>
                        <div class="form-group row">
                            <div class="col md-3">
                                Document Type
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col" id="attachment-txt"></div>
                        </div>
                        <div class="form-group row">
                            <div class="col md-3">
                                The Parties
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="next-review-btn" style="width:90px">Next</button>
                <button type="submit" class="btn btn-primary" id="submit-review-btn" style="width:90px;display:none">Submit</button>
            </div>
            </form>
        </div>
    </div>
...
<!-- Modal Add Folder-->
<div class="modal fade" id="reviewDetailModal" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-primary" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="col">
