...
<main class="main">
    <div class="container-fluid">
        <div class="animated fadeIn">
            <div class="page-title-heading">
                <div class="page-title-icon">
                    <i class="fa fa-gears icon-gradient bg-deep-blue"></i>
                </div>
                <div>Documents In Process</div>
            </div>
            <!-- /.card-->
            <div class="row pt-3">
                <div class="col">
        ...
        <input type="hidden" id="data-tbl-url" name="data-tbl-url" value="{{route('getProcessedDocs')}}">
    </main>
@endsection
@section ('modal')
<!-- Modal Add Folder-->
